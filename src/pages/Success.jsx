...
const Success = () => {
  ...
  return (
    ...
    >
      <h1 style={{ fontSize: '3rem', color: 'var(--accent-neon)', marginBottom: '20px', fontFamily: 'var(--font-mono)' }}>_CONFIRMATION_LOGGED</h1>
      ...
      <Link to="/">
        <button className="system-btn">RET_TO_DATABASE</button>
      </Link>
    </motion.div>
  );
};
